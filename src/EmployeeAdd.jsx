    ...
    render() {
        return (
            <>
                ...
                <Button type="submit" variant="primary" size="sm" onClick={this.handleShowModal}>New Employee</Button>
                </div>
                <Modal show={this.state.modalVisible} onHide={this.handleHideModal} centered>
                    ...
                    <Modal.Footer>
                        <Button type="submit" variant="success" size="sm" onClick={this.handleSubmit} className='mt-4'>Add Employee</Button>
                    </Modal.Footer>
                </Modal>
            </>
        )
